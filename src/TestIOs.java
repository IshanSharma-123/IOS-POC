...
public class TestIOs {
	...
	public static void main(String[] args) throws InterruptedException, MalformedURLException {
	   ...
	   //capabilities.setCapability(MobileCapabilityType.APP, "/Users/ishans/Desktop/IntegrationApp.app");
	   //capabilities.setCapability(MobileCapabilityType.APP, "/Users/ishans/Desktop/CollegeHunch.ipa");
		capabilities.setCapability(MobileCapabilityType.APP, "/Users/ishans/Desktop/Tata_Test_App.ipa");
	...
	//   driver.findElements(By.xpath("//element[@value='First Name']")).clear();
	    //driver.findElement(By.xpath("//*[contains(text(),'First Name')]")).sendKeys("santhosh");
